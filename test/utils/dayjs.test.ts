...
describe('SimpleDayjs', () => {
  ...
  it('should format the end of the ...', () => {
    const date = simpleDayjs('2024-02-10');
    expect(date.endOf('year').format('YYYY-MM-DD HH:mm:ss')).toBe(
      '2024-12-31 23:59:59'
    );
    expect(date.endOf('month').format('YYYY-MM-DD HH:mm:ss')).toBe(
      '2024-02-29 23:59:59'
    );
    expect(date.endOf('day').format('YYYY-MM-DD HH:mm:ss')).toBe(
      '2024-02-10 23:59:59'
    );
  });
